# Emergency Response — `/industrial-services/emergency-response/`
...
### Miller is ready and able...
> To provide emergency spill management 24 hours a day. Spill responses can vary significantly depending on the environment they occur within. Every spill that Miller attends to is unique and requires a customized approach which is determined by its type and size.
