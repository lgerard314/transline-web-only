  ...
  return (
    <div className="tl-pagewrap">
      <PageHero
        ...
        title={
          <>
            Environmental services for <span style={{ color: "var(--c-accent)" }}>cross-border</span> disposal, recycling &amp; logistics.
          </>
        }
        ...
        ctas={
          <>
            ...
            <Link href="/cross-border-process" className="tl-btn tl-btn--ghost-light">
        ...
        <div className="tl-container">
          ...
          <div style={{ display: "flex", flexDirection: "column", borderTop: "1px solid var(--c-line)" }}>
            {SERVICES.map((s, i) => (
              <div
                key={i}
                data-tlgrid-collapse=""
                data-reveal=""
                className="tl-svcdetail__row"
                style={{
                  display: "grid",
              ...
              >
                ...
                >
                  ...
                  <div style={{ position: "absolute", bottom: 24, left: 24, right: 24, color: "rgba(255,255,255,0.95)", fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.1em", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div className="tl-svcdetail__text" style={{ padding: "56px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
                    <span style={{ width: 36, height: 36, borderRadius: 999, border: "1px solid var(--c-line)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--c-blue)" }}>
                      <Icon name={s.icon} />
                    </span>
                  ...
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, borderTop: "1px solid var(--c-line)" }}>
                    {s.bullets.map((b, j) => (
                      <li key={j} style={{ padding: "12px 0", borderBottom: "1px solid var(--c-line)", display: "flex", alignItems: "center", gap: 12, color: "var(--c-ink)", fontSize: 14.5 }}>
      ...
      <section className="tl-section" style={{ background: "var(--c-surface)", borderBlock: "1px solid var(--c-line)" }}>
        <div className="tl-container">
          ...
          <div data-tlgrid-collapse="" data-reveal-stagger="" className="tl-industries-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 0, borderTop: "1px solid var(--c-line)", borderLeft: "1px solid var(--c-line)" }}>
            {[
              ...
              <div key={i} style={{ padding: "32px 28px", borderRight: "1px solid var(--c-line)", borderBottom: "1px solid var(--c-line)", background: "var(--c-surface)", minHeight: 140, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                <span className="tl-mono" style={{ color: "var(--c-ink-3)", fontSize: 11, letterSpacing: "0.1em" }}>
                  {String(i + 1).padStart(2, "0")} / 06
                </span>
                <div style={{ fontFamily: "var(--font-display)", fontSize: 22, fontWeight: 500, letterSpacing: "-0.01em", color: "var(--c-navy)", lineHeight: 1.15 }}>
                  {it}
                </div>
              </div>
            ))}
        ...
        <div className="tl-container" data-tlgrid-collapse="" style={{ display: "grid", gridTemplateColumns: "1fr 1.3fr", gap: 64, alignItems: "start" }}>
          <div data-tlsticky="" style={{ position: "sticky", top: 96 }}>
            ...
            <div style={{ marginTop: 32 }}>
              <Link href="/contact" className="tl-btn tl-btn--dark">
          ...
          <div>
            <ul data-reveal-stagger="" style={{ listStyle: "none", padding: 0, margin: 0, borderTop: "1px solid var(--c-line)" }}>
              {[
                ...
                <li key={i} style={{ padding: "20px 0", borderBottom: "1px solid var(--c-line)", display: "grid", gridTemplateColumns: "60px 1fr", gap: 16, alignItems: "baseline" }}>
                  <span className="tl-mono" style={{ color: "var(--c-blue)", fontSize: 12, letterSpacing: "0.08em" }}>{it.k}</span>
                  <div>
                    <div style={{ fontFamily: "var(--font-display)", fontSize: 19, fontWeight: 500, letterSpacing: "-0.01em", color: "var(--c-navy)", marginBottom: 4 }}>
                      {it.t}
                    </div>
      ...
      <section style={{ background: "var(--c-navy)" }}>
        <div className="tl-container" data-tlgrid-collapse="" style={{ paddingTop: "clamp(56px, 11vw, 96px)", paddingBottom: "clamp(56px, 11vw, 96px)", display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 64, alignItems: "center" }}>
          <div>
