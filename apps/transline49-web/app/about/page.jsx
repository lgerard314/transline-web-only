  ...
  return (
    <div className="tl-pagewrap">
      <PageHero
        ...
        title={
          <>
            A U.S.–Canada environmental services <span style={{ color: "var(--c-accent)" }}>connection.</span>
          </>
        }
      ...
      <section className="tl-section" style={{ background: "var(--c-surface)", borderBlock: "1px solid var(--c-line)" }}>
        <div className="tl-container">
          <SectionHead eyebrow="02 · OUR ROLE" title="Three things we do, in plainer English." />

          <div data-tlgrid-collapse="" data-reveal-stagger="" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 0, borderTop: "1px solid var(--c-line)", borderBottom: "1px solid var(--c-line)" }}>
            {[
              { tag: "GUIDE",       t: "Cross-border path",       b: "We help customers understand whether their material can move into Canada — and what it takes.", icon: "north" },
              { tag: "COORDINATOR", t: "Permits & movement",      b: "We support permitting and movement logistics, working between you, regulators, carriers, and receiving facilities.", icon: "doc" },
              { tag: "CONNECTOR",   t: "Canadian outlets",        b: "We provide access to Canadian disposal, treatment, recycling, and repurposing options for hazardous and non-hazardous waste.", icon: "recycle" },
            ].map((c, i) => (
              <div key={i} style={{ padding: "40px 32px", borderLeft: i === 0 ? 0 : "1px solid var(--c-line)", minHeight: 320, display: "flex", flexDirection: "column", justifyContent: "space-between", gap: 20 }}>
                <div>
                  <span style={{ width: 48, height: 48, display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid var(--c-line)", borderRadius: 999, color: "var(--c-blue)", marginBottom: 24 }}>
                    <Icon name={c.icon} />
                  </span>
                  <span className="tl-mono" style={{ color: "var(--c-blue)", fontSize: 11, letterSpacing: "0.12em" }}>ROLE · {c.tag}</span>
        ...
        <div className="tl-container">
          ...
          <div data-tlgrid-collapse="" data-reveal-stagger="" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 24 }}>
            <div className="tl-card">
              ...
              <div style={{ borderTop: "1px solid var(--c-line)", paddingTop: 20, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <div className="tl-affil-list" style={{ borderTop: "1px solid rgba(255,255,255,0.12)", paddingTop: 20 }}>
                  {[
                    ...
                    <div key={i} style={{ padding: "12px 0", display: "grid", gridTemplateColumns: "180px 1fr", gap: 12, borderBottom: i < 2 ? "1px solid rgba(255,255,255,0.08)" : 0 }}>
                      <span className="tl-mono" style={{ fontSize: 11, color: "rgba(230,238,242,0.5)", letterSpacing: "0.1em" }}>{it.k}</span>
      ...
      <section className="tl-section" style={{ background: "linear-gradient(180deg, #122C3A 0%, #0B1F2A 100%)", color: "var(--c-on-navy)" }}>
        <div className="tl-container" data-tlgrid-collapse="" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          ...
          <div data-tlgrid-collapse="" data-reveal-stagger="" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              ...
              <div key={i} style={{ border: "1px solid rgba(255,255,255,0.1)", borderRadius: 10, padding: "20px 18px", background: "rgba(255,255,255,0.02)" }}>
                <span className="tl-mono" style={{ color: "var(--c-accent)", fontSize: 11, letterSpacing: "0.1em" }}>{c.k}</span>
                <h3 style={{ fontFamily: "var(--font-display)", fontSize: 22, fontWeight: 500, color: "#fff", margin: "8px 0 8px", letterSpacing: "-0.01em" }}>{c.t}</h3>
                <p style={{ fontSize: 13.5, color: "rgba(230,238,242,0.7)", lineHeight: 1.5, margin: 0 }}>{c.b}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="tl-container">
          ...
          <div data-reveal-stagger="" style={{ borderTop: "1px solid var(--c-line)" }}>
            {[
              ...
              <div key={i} data-tlgrid-collapse="" style={{ padding: "24px 0", borderBottom: "1px solid var(--c-line)", display: "grid", gridTemplateColumns: "60px 1fr auto", gap: 32, alignItems: "center" }}>
                <span className="tl-mono" style={{ color: "var(--c-blue)", fontSize: 12, letterSpacing: "0.08em" }}>{String(i + 1).padStart(2, "0")}</span>
                <div>
                  <div style={{ fontFamily: "var(--font-display)", fontSize: 22, fontWeight: 500, color: "var(--c-navy)", letterSpacing: "-0.01em", marginBottom: 6 }}>{it.t}</div>
                  <div className="tl-body" style={{ fontSize: 14.5 }}>{it.b}</div>
                </div>
                <span className="tl-mono" style={{ color: "var(--c-accent-2)", fontSize: 11, letterSpacing: "0.1em" }}>✓ CORE</span>
              </div>
            ))}
          </div>
        </div>
