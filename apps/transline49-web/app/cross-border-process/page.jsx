  ...
  return (
    <div className="tl-pagewrap">
      <PageHero
        ...
        title={
          <>
            A clearer path through cross-border <span style={{ color: "var(--c-accent)" }}>requirements.</span>
          </>
        }
        ...
        ctas={
          <>
            ...
            <a href="#tl-process-faq" className="tl-btn tl-btn--ghost-light">
      ...
      <section className="tl-section" style={{ background: "var(--c-surface)", borderBlock: "1px solid var(--c-line)" }}>
        <div className="tl-container">
          ...
          <div data-tlgrid-collapse="" data-reveal-stagger="" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 0, borderTop: "1px solid var(--c-line)", borderBottom: "1px solid var(--c-line)" }}>
            {[
              ...
              <div key={i} style={{ padding: "36px 28px 32px", borderLeft: i === 0 ? 0 : "1px solid var(--c-line)", minHeight: 240 }}>
                <div className="tl-mono" style={{ color: "var(--c-blue)", fontSize: 12, letterSpacing: "0.08em" }}>{c.k} / 04</div>
      ...
      <section className="tl-section">
        <div className="tl-container">
          <SectionHead eyebrow="WHERE TRANSLINE49° HELPS" title="What you bring vs. what we coordinate." />

          <div data-tlgrid-collapse="" data-reveal-stagger="" className="tl-process-help-row" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0, borderTop: "1px solid var(--c-line)", borderBottom: "1px solid var(--c-line)" }}>
            <div style={{ padding: "40px 0 40px", paddingRight: 32, borderRight: "1px solid var(--c-line)" }}>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                {[
                  ...
                  <li key={i} style={{ padding: "14px 0", borderTop: "1px solid var(--c-line-2)", display: "flex", gap: 16, alignItems: "baseline" }}>
                    <span className="tl-mono" style={{ color: "var(--c-ink-3)", fontSize: 11, width: 28 }}>{String(i + 1).padStart(2, "0")}</span>
            ...
            <div style={{ padding: "40px 0 40px", paddingLeft: 32 }}>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                {[
                  ...
                  <li key={i} style={{ padding: "14px 0", borderTop: "1px solid var(--c-line-2)", display: "flex", gap: 16, alignItems: "baseline" }}>
                    <span className="tl-mono" style={{ color: "var(--c-accent-2)", fontSize: 11, width: 28 }}>✓</span>
                    <span style={{ color: "var(--c-ink)", fontSize: 15.5 }}>{it}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="tl-section" id="tl-process-faq" style={{ background: "var(--c-surface)", borderTop: "1px solid var(--c-line)", scrollMarginTop: 96 }}>
        <div className="tl-container" data-tlgrid-collapse="" style={{ display: "grid", gridTemplateColumns: "0.7fr 1fr", gap: 64, alignItems: "start" }}>
          <div data-tlsticky="" style={{ position: "sticky", top: 96 }}>
            ...
            <h2 className="tl-display tl-display--l" style={{ marginTop: 24 }}>Frequently asked.</h2>
          ...
          <div>
            <FAQ
              items={[
                { q: "Who is TransLine49° Environmental Services?", a: "TransLine49° is a U.S.-based environmental services company headquartered in St. Louis, Missouri and affiliated with Miller Environmental Corporation. We focus on helping customers move waste from the United States into Canada." },
                { q: "What does TransLine49° help with?", a: "Cross-border waste movement, hazardous waste permitting, logistics coordination, and access to Canadian disposal, treatment, recycling, and repurposing options." },
                { q: "How do I start a project?", a: "Use the Start a Project form on the contact page, or call (314) 934-2133. Most reviews begin with a brief call to understand the material and the constraints." },
                { q: "What information do you need?", a: "At minimum: a description of the material, its location, an estimate of volume, and your timeline. Existing analytical data or waste profile, if you have it, helps us evaluate options faster." },
                { q: "Do you handle hazardous waste permitting?", a: "Yes. TransLine49° assists with cross-border hazardous waste permitting — including coordinating the workflow and helping with documentation." },
                { q: "Do you coordinate logistics?", a: "Yes. We schedule and coordinate the logistical movement of material, working with the customer, carriers, and receiving facility." },
              ]}
            />
          </div>
        </div>
      ...
      <section style={{ background: "var(--c-navy)" }}>
        <div className="tl-container" data-tlgrid-collapse="" style={{ paddingTop: "clamp(56px, 11vw, 96px)", paddingBottom: "clamp(56px, 11vw, 96px)", display: "grid", gridTemplateColumns: "1fr auto", gap: 48, alignItems: "center" }}>
          <div>
