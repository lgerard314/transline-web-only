// Simplified macOS Chrome browser chrome — dark theme, all inline styles +
// inline SVG so no image assets. Kept for any future mock screens; not used
// by the live marketing pages today.
