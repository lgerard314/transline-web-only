...
export const projectManagement = {
  ...
  portfolio: {
    ...
    items: [
      {
        name: "Demolitions",
        body: "Controlled teardown and debris management.",
      ...
      },
      {
        ...
        body: "Engineered, lined containment ponds built to spec.",
      ...
      },
      {
        ...
        body: "Excavation and treatment of contaminated soils.",
        tag: "Excavation · Treatment",
        photo: "/miller/pm/portfolio-soil.png",
      },
      {
        name: "Spill abatement",
        body: "Containment and abatement of hazardous spills.",
        tag: "Containment · Recovery",
        photo: "/miller/pm/portfolio-spill.png",
      },
      {
        name: "Asbestos removal",
        body: "Compliant removal and disposal of asbestos.",
        tag: "Abatement · Disposal",
        photo: "/miller/pm/portfolio-asbestos.png",
      },
      {
        name: "Building design",
        body: "In-house design for facilities and structures.",
        tag: "Design · Build",
