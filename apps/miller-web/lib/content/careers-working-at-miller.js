...
// Source: docs/superpowers/miller-scrape/24-careers-working-at-miller.md

export const careersWorkingAtMiller = {
  hero: {
    eyebrow: "Careers",
  ...
  sections: [
    {
      heading: "Core values define us",
      body:
        "Respect. Empowerment & Accountability. Teamwork. Healthy Work Environment.",
    },
    {
      heading: "Diversity, equity, and inclusion at Miller",
      body:
