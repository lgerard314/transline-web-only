...
export const emergencyResponse = {
  ...
  incidents: {
    ...
    items: [
      { name: "Chemical\nspills", blurb: "Acids, caustics, and reactive process chemicals contained at the source.", photo: "/miller/custom/chemical-spills.png" },
      { name: "Fuel & diesel\nreleases", blurb: "Tank, line, and roadway fuel releases recovered before they spread.", photo: "/miller/custom/fuel-and-diesel-spills.png" },
      { name: "Transport\nincidents", blurb: "Highway and rail cargo spills cleared and the corridor reopened.", photo: "/miller/custom/transport-incidents.png" },
      { name: "Industrial\nleaks", blurb: "Process and equipment failures sealed and the area made safe.", photo: "/miller/custom/industrial-leaks.png" },
      { name: "Dangerous\ngoods", blurb: "Flammable, corrosive, and toxic DG handled to TDG standards.", photo: "/miller/custom/dangerous-goods.png" },
      { name: "Confined-space\nentry", blurb: "Trained entry into vaults, sumps, and vessels others can't reach.", photo: "/miller/custom/confined-space-entry.png" },
      { name: "Vessel & tank\nfailures", blurb: "Ruptured tanks drained, contained, and decontaminated on site.", photo: "/miller/custom/vessel-and-tank-failures.png" },
      { name: "Contaminated\nsoil", blurb: "Impacted soil excavated, treated, and routed to VBEC.", photo: "/miller/custom/contaminated-soul.png" },
    ],
  },
    ...
    provides: [
      {
        ...
        photo: "/miller/custom/24-hour-emergency-response-availability.png",
        bigAnchor: "50% 50%",
        thumbAnchor: "50% 52%",
      ...
      },
      {
        ...
        photo: "/miller/custom/response-coordination.png",
        bigAnchor: "50% 62%",
        thumbAnchor: "50% 66%",
      ...
      },
      {
        ...
        photo: "/miller/custom/spill-containment-portrait.png",
        bigAnchor: "50% 50%",
        thumbAnchor: "50% 50%",
      ...
      },
      {
        ...
        photo: "/miller/custom/snowing-hazmat-cleaning.png",
        bigAnchor: "50% 15%",
        thumbAnchor: "50% 20%",
      ...
      },
      {
        ...
        photo: "/miller/custom/confined-space-response.png",
        bigAnchor: "50% 100%",
        thumbAnchor: "50% 44%",
