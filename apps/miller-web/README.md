...
the **template guide** in the website-design skill (`.claude/skills/website-design/references\white-owl-templates.md` — `components-v2/README.md` is a stub), browse
the live catalog at **`/template-gallery`**, and use **`npm run template-map`** to
see which pages a template change would affect. Visual baseline: `.claude/skills/website-design/references\white-owl-design-system.md` in the website-design skill (`docs/DESIGN-SYSTEM.md` is a stub).
