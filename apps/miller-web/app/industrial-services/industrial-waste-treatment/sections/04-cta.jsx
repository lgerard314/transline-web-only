...
// §4 — Closing CTA. Dark walnut dispatch panel: contact form floats as a warm
// cream card on the left; the 24/7 hotline anchors the right.
export function CtaSection() {
  const h = c.hero;
  const cta = c.cta;
  return (
    <section className="mw-svc-cta mw-svc-cta--dark" aria-labelledby="iwt-cta-title">
      <div className="mw-svc-cta__inner mw-inner mw-svc-cta__grid mw-svc-cta__grid--reverse">
        ...
        <div className="mw-svc-cta__content" data-reveal>
          ...
          <h2 id="iwt-cta-title" className="mw-section-title mw-svc-cta__title">
            {cta.title}{" "}
