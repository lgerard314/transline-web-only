...
export function HeroSection() {
  const h = c.hero;
  return (
    <section className="mw-svc-hero mw-svc-hero--alert mw-svc-hero--photo-50" aria-labelledby="ic-hero-title">
      <div className="mw-svc-hero__inner mw-inner">
        <div className="mw-svc-hero__content">
          ...
          <h1 id="ic-hero-title" className="mw-svc-hero__title" data-reveal>
            {h.title}<br />
