...
// closed" on its border when an ancestor flips data-mx-seal="closed" — the
...
export function DiamondSeal({ children, legend = "ON THE RECORD", draw = "default" }) {
  return (
      ...
      <svg className="mx-seal__frame" viewBox="0 0 200 200" aria-hidden="true" preserveAspectRatio="none">
        {draw === "split" ? (
          <>
            ...
            <path className="mx-seal__edge" pathLength="100"
