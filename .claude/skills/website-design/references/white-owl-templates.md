<!-- MOVED 2026-06-12 from apps/miller-web/components-v2/README.md — now the single source of truth inside the website-design skill. Section (§) numbers cited anywhere in the repo refer to THIS file. -->

# components-v2 — the miller-web template library

**Read this before building or changing any miller-web page or template.** This is the authoritative build guide; root `CLAUDE.md` points here and `references/white-owl-design-system.md (this skill)` is the visual baseline it implements. The warm-clay non-negotiables in those docs still apply to everything here.
...
- Visual baseline (palette, type, motifs, section rhythm, interior rules): `references/white-owl-design-system.md (this skill)`.
