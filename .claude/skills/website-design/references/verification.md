...
- Write scripts/screenshots to your own scratch dir (e.g. `_scratch_<page>/`), and run node scripts from the repo root the dependencies live in (cwd drift = phantom "module not found").
