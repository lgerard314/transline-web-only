    ...
    <div className="tl-pagewrap">
      ...
      <section className="tl-section" style={{ background: "var(--c-surface)", borderBlock: "1px solid var(--c-line)" }}>
        <div className="tl-container">
          ...
          <div data-tlgrid-collapse data-reveal-stagger style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 0,
      ...
      <section className="tl-section">
        <div className="tl-container">
          ...
          <div data-tlgrid-collapse data-reveal-stagger className="tl-process-help-row" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0,
                        borderTop: "1px solid var(--c-line)", borderBottom: "1px solid var(--c-line)" }}>
      ...
      <section style={{ background: "var(--c-navy)" }}>
        <div className="tl-container" data-tlgrid-collapse style={{ paddingTop: "clamp(56px, 11vw, 96px)", paddingBottom: "clamp(56px, 11vw, 96px)", display: "grid",
